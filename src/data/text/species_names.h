const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    // Legends: Arceus. Spelled in full -- POKEMON_NAME_LENGTH is 12 here, so
    // the donor's 10-char abbreviation ("Basculegn") is not needed.
...
// ROWESPEC-PORT-START names (generated by tools/character_mode/port_2x_species.py)
    ...
    [SPECIES_POLTCHAGEIST_ARTISAN] = _("Poltchageist"),
