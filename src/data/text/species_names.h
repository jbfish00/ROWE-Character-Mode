...
// GEN9-PORT-START names (generated by tools/character_mode/port_gen9.py)
    ...
    [SPECIES_OINKOLOGNE] = _("Oinkolgne"),
    ...
    [SPECIES_BRAMBLEGHAST] = _("Brmbleghst"),
    ...
    [SPECIES_DUDUNSPARCE] = _("Dudnsparce"),
    ...
    [SPECIES_IRON_VALIANT] = _("IrnValiant"),
    ...
    [SPECIES_POLTCHAGEIST] = _("Poltchagst"),
    ...
    [SPECIES_GOUGING_FIRE] = _("GougngFire"),
...
// ROWEMEGA-PORT-START names (generated by tools/character_mode/port_rowe_megas.py)
    ...
    [SPECIES_CLEFABLE_MEGA_REDUX] = _("Clefable"),
    [SPECIES_CLODSIRE_MEGA] = _("Clodsire"),
    [SPECIES_COALOSSAL_MEGA] = _("Coalossal"),
    [SPECIES_CORVIKNIGHT_MEGA] = _("Corviknigh"),
    [SPECIES_CRABOMINABLE_MEGA] = _("Crabminabl"),
    ...
    [SPECIES_SAMUROTT_HISUI_MEGA] = _("Samurott"),
    ...
    [SPECIES_SLOWBRO_GALAR_MEGA] = _("Slowbro"),
    [SPECIES_SLOWKING_GALAR_MEGA] = _("Slowking"),
    ...
    [SPECIES_STARMIE_MEGA_REDUX] = _("Starmie"),
    [SPECIES_TATSUGIRI_MEGA_CURLY] = _("Tatsugiri"),
    [SPECIES_TINKATON_MEGA] = _("Tinkaton"),
    [SPECIES_TOUCANNON_MEGA] = _("Toucannon"),
    [SPECIES_TOXTRICITY_MEGA] = _("Toxtricity"),
    [SPECIES_TOXTRICITY_MEGA_LOW_KEY] = _("Toxtricity"),
    [SPECIES_TSAREENA_MEGA] = _("Tsareena"),
    [SPECIES_TYPHLOSION_HISUI_MEGA] = _("Typhlosion"),
    [SPECIES_TYPHLOSION_MEGA] = _("Typhlosion"),
    [SPECIES_URSHIFU_MEGA_RAPID_STRIKE] = _("Urshifu"),
    [SPECIES_URSHIFU_MEGA_SINGLE_STRIKE] = _("Urshifu"),
    [SPECIES_VENUSAUR_MEGA_G] = _("Venusaur"),
    [SPECIES_VICTREEBEL_MEGA] = _("Victreebel"),
    [SPECIES_ZERAORA_MEGA] = _("Zeraora"),
    [SPECIES_ZYGARDE_MEGA] = _("Zygarde"),
// ROWEMEGA-PORT-END names
// ROWESPEC-PORT-START names (generated by tools/character_mode/port_2x_species.py)
    [SPECIES_BASCULIN_WHITE_STRIPED] = _("Basculin"),
    [SPECIES_DARMANITAN_GALAR_ZEN] = _("Darmanitan"),
    [SPECIES_DIALGA_ORIGIN] = _("Dialga"),
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] = _("Dudunsparc"),
    [SPECIES_FLOETTE_ETERNAL_MEGA] = _("Floette"),
    [SPECIES_FLOETTE_MEGA] = _("Floette"),
    [SPECIES_MAUSHOLD_FOUR] = _("Maushold"),
    [SPECIES_MEOWSTIC_MEGA_F] = _("Meowstic"),
    ...
    [SPECIES_OINKOLOGNE_F] = _("Oinkologne"),
    [SPECIES_PALAFIN_HERO] = _("Palafin"),
    [SPECIES_PALKIA_ORIGIN] = _("Palkia"),
    [SPECIES_POLTCHAGEIST_ARTISAN] = _("Poltchagei"),
    [SPECIES_SANDSLASH_MEGA_ALOLA] = _("Sandslash"),
    [SPECIES_SHEDINJA_MEGA] = _("Shedinja"),
    [SPECIES_SINISTCHA_MASTERPIECE] = _("Sinistcha"),
    [SPECIES_SQUAWKABILLY_BLUE] = _("Squawkbily"),
    [SPECIES_SQUAWKABILLY_GREEN] = _("Squawkbily"),
    [SPECIES_SQUAWKABILLY_WHITE] = _("Squawkbily"),
    [SPECIES_SQUAWKABILLY_YELLOW] = _("Squawkbily"),
    [SPECIES_TATSUGIRI_CURLY] = _("Tatsugiri"),
    [SPECIES_TATSUGIRI_DROOPY] = _("Tatsugiri"),
    [SPECIES_TATSUGIRI_MEGA_DROOPY] = _("Tatsugiri"),
    [SPECIES_TATSUGIRI_MEGA_STRETCHY] = _("Tatsugiri"),
