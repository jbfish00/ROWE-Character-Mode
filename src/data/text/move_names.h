...
#endif
// ROWEMOVE-PORT-START names (generated by tools/character_mode/port_2x_moves.py)
    ...
    [MOVE_NEUTRAL_PULSE] = _("Neutral Pulse"),
    [MOVE_SEASONAL_BEAM] = _("Seasonal Beam"),
    [MOVE_RAGING_FURY] = _("Raging Fury"),
    [MOVE_HITONOME] = _("Hitonome"),
    [MOVE_TRICKONOME] = _("Trickonome"),
    [MOVE_AMPONOME] = _("Amponome"),
    [MOVE_WEAKONOME] = _("Weakonome"),
    [MOVE_TORCH_SONG] = _("Torch Song"),
    [MOVE_INVERSE_ROOM] = _("Inverse Room"),
    [MOVE_BARB_BARRAGE] = _("Mil Púas"),
    [MOVE_BITTER_MALICE] = _("Rencor Maligno"),
    [MOVE_BLEAKWIND_STORM] = _("Vendaval Gélido"),
    [MOVE_CEASELESS_EDGE] = _("Filo Perpetuo"),
    [MOVE_CHLOROBLAST] = _("Clorofiláser"),
    [MOVE_DIRE_CLAW] = _("Garra Nociva"),
    [MOVE_ESPER_WING] = _("Ala Psíquica"),
    [MOVE_HEADLONG_RUSH] = _("Carga Brusca"),
    [MOVE_INFERNAL_PARADE] = _("CrtejoInfernal"),
    [MOVE_LUNAR_BLESSING] = _("Plegaria Lunar"),
    [MOVE_MOUNTAIN_GALE] = _("Ventisca Polar"),
    [MOVE_MYSTICAL_POWER] = _("Poder Místico"),
    [MOVE_POWER_SHIFT] = _("Cambiafuerza"),
    [MOVE_PSYSHIELD_BASH] = _("Psicoescudo"),
    [MOVE_SANDSEAR_STORM] = _("Vendaval Ígneo"),
    [MOVE_SHELTER] = _("Refugio"),
    [MOVE_SPRINGTIDE_STORM] = _("VendavalPasión"),
    [MOVE_STONE_AXE] = _("Hachazo Pétreo"),
    [MOVE_TAKE_HEART] = _("Reconfortar"),
    [MOVE_TRIPLE_ARROWS] = _("Triple Flecha"),
    [MOVE_VICTORY_DANCE] = _("Danza Victoria"),
    [MOVE_WILDBOLT_STORM] = _("VendavalEléct"),
    [MOVE_10000000_VOLT_THUNDERBOLT] = _("Gigarrayorrayo"),
    [MOVE_ACID_DOWNPOUR] = _("Diluvio Corros."),
    [MOVE_ALL_OUT_PUMMELING] = _("Ráfaga Puños"),
    [MOVE_BLACK_HOLE_ECLIPSE] = _("Agujero Negro"),
    [MOVE_BLOOM_DOOM] = _("Megatón Floral"),
    [MOVE_BREAKNECK_BLITZ] = _("Sprint Letal"),
    [MOVE_CATASTROPIKA] = _("PikavoltioLetal"),
    [MOVE_CLANGOROUS_SOULBLAZE] = _("Alma Dragón"),
    [MOVE_CONTINENTAL_CRUSH] = _("Aplast.Gigalít"),
    [MOVE_CORKSCREW_CRASH] = _("Barrena Bólido"),
    [MOVE_DEVASTATING_DRAKE] = _("Dracoaliento"),
    [MOVE_EXTREME_EVOBOOST] = _("NovenaPotencia"),
    [MOVE_GENESIS_SUPERNOVA] = _("Gén. Supernova"),
    [MOVE_GIGAVOLT_HAVOC] = _("Gigavolt.Caos"),
    [MOVE_GUARDIAN_OF_ALOLA] = _("CóleraGuardián"),
    [MOVE_HYDRO_VORTEX] = _("Hidrovórtice"),
    [MOVE_INFERNO_OVERDRIVE] = _("Hecatombe Ígn."),
    [MOVE_LETS_SNUGGLE_FOREVER] = _("Abrazo Mimikyu"),
    [MOVE_LIGHT_THAT_BURNS_THE_SKY] = _("Fotodestrucción"),
    [MOVE_MALICIOUS_MOONSAULT] = _("Hiperplaneo"),
    [MOVE_MENACING_MOONRAZE_MAELSTROM] = _("Rayo Lunar"),
    [MOVE_NEVER_ENDING_NIGHTMARE] = _("PesadillaInfin"),
    [MOVE_OCEANIC_OPERETTA] = _("SinfoníaMarítm"),
    [MOVE_PULVERIZING_PANCAKE] = _("Placaje Pancake"),
    [MOVE_SAVAGE_SPIN_OUT] = _("TelarañaMortal"),
    [MOVE_SEARING_SUNRAZE_SMASH] = _("MegarrayoSolar"),
    [MOVE_SHATTERED_PSYCHE] = _("Psicocarga"),
    [MOVE_SINISTER_ARROW_RAID] = _("Lluvia Flechas"),
    [MOVE_SOUL_STEALING_7_STAR_STRIKE] = _("7 Estrellas"),
    [MOVE_SPLINTERED_STORMSHARDS] = _("Litoestalactita"),
    [MOVE_STOKED_SPARKSURFER] = _("SurfeoGalvánic"),
    [MOVE_SUBZERO_SLAMMER] = _("Criogeiser"),
    [MOVE_SUPERSONIC_SKYSTRIKE] = _("PicadoSupersón"),
    [MOVE_TECTONIC_RAGE] = _("FuriaTectónica"),
    [MOVE_TWINKLE_TACKLE] = _("Fuerza Feérica"),
    [MOVE_MAX_AIRSTREAM] = _("Maxiaire"),
    [MOVE_MAX_DARKNESS] = _("Maxisombra"),
    [MOVE_MAX_FLARE] = _("Maxillamarada"),
    [MOVE_MAX_FLUTTERBY] = _("Maxinsecto"),
    [MOVE_MAX_GEYSER] = _("Maxigeiser"),
    [MOVE_MAX_GUARD] = _("Maxibarrera"),
    [MOVE_MAX_HAILSTORM] = _("Maxigranizo"),
    [MOVE_MAX_KNUCKLE] = _("Maxipuño"),
    [MOVE_MAX_LIGHTNING] = _("Maxirrelámpa."),
    [MOVE_MAX_MINDSTORM] = _("Maxionda"),
    [MOVE_MAX_OOZE] = _("Maxiácido"),
    [MOVE_MAX_OVERGROWTH] = _("Maxibosque"),
    [MOVE_MAX_PHANTASM] = _("Maxifantasma"),
    [MOVE_MAX_QUAKE] = _("Maxitemblor"),
    [MOVE_MAX_ROCKFALL] = _("Maxilito"),
    [MOVE_MAX_STARFALL] = _("Maxiestela"),
    [MOVE_MAX_STEELSPIKE] = _("Maxiacero"),
    [MOVE_MAX_STRIKE] = _("Maxiataque"),
    [MOVE_MAX_WYRMWIND] = _("Maxidragón"),
    [MOVE_G_MAX_BEFUDDLE] = _("Gigaconfusión"),
    [MOVE_G_MAX_CANNONADE] = _("Gigacañonazo"),
    [MOVE_G_MAX_CENTIFERNO] = _("Gigacentella"),
    [MOVE_G_MAX_CHI_STRIKE] = _("Gigagolpe Chi"),
    [MOVE_G_MAX_CUDDLE] = _("Gigamimo"),
    [MOVE_G_MAX_DEPLETION] = _("Gigausura"),
    [MOVE_G_MAX_DRUM_SOLO] = _("Gigabatería"),
    [MOVE_G_MAX_FINALE] = _("Gigafinal"),
    [MOVE_G_MAX_FIREBALL] = _("Gigaesfera"),
    [MOVE_G_MAX_FOAM_BURST] = _("Gigaespuma"),
    [MOVE_G_MAX_GOLD_RUSH] = _("Gigamoneda"),
    [MOVE_G_MAX_GRAVITAS] = _("Gigagravedad"),
    [MOVE_G_MAX_HYDROSNIPE] = _("Gigafrancotir."),
    [MOVE_G_MAX_MALODOR] = _("Gigahedor"),
    [MOVE_G_MAX_MELTDOWN] = _("Gigafusión"),
    [MOVE_G_MAX_ONE_BLOW] = _("GigagolpeÚnico"),
    [MOVE_G_MAX_RAPID_FLOW] = _("Gigaflujo"),
    [MOVE_G_MAX_REPLENISH] = _("Gigarreciclaje"),
    [MOVE_G_MAX_RESONANCE] = _("Gigaresonancia"),
    [MOVE_G_MAX_SANDBLAST] = _("Gigarenales"),
    [MOVE_G_MAX_SMITE] = _("Gigahechizo"),
    [MOVE_G_MAX_SNOOZE] = _("Gigasopor"),
    [MOVE_G_MAX_STEELSURGE] = _("GigatrampaAc."),
    [MOVE_G_MAX_STONESURGE] = _("GigatrampaRo."),
    [MOVE_G_MAX_STUN_SHOCK] = _("Gigadescarga"),
    [MOVE_G_MAX_SWEETNESS] = _("Gigadulzura"),
    [MOVE_G_MAX_TARTNESS] = _("Gigaacidez"),
    [MOVE_G_MAX_TERROR] = _("Gigaterror"),
    [MOVE_G_MAX_VINE_LASH] = _("Gigalátigo"),
    [MOVE_G_MAX_VOLCALITH] = _("Gigaerupción"),
    [MOVE_G_MAX_VOLT_CRASH] = _("Gigatrueno"),
    [MOVE_G_MAX_WILDFIRE] = _("Gigallamarada"),
    [MOVE_G_MAX_WIND_RAGE] = _("Gigahuracán"),
    [MOVE_PLACEHOLDER] = _("Placeholder"),
// ROWEMOVE-PORT-END names
};
