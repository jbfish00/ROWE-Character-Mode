...
// ROWENEWTRN-START animdefs (generated by tools/character_mode/port_2x_new_trainers.py)
static const union AnimCmd *const sAnims_Hilda[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_LeaderRoark[] ={
    sAnim_GeneralFrame0,
};
static const union AnimCmd *const sAnims_LeaderGardenia[] ={
    sAnim_GeneralFrame0,
};
static const union AnimCmd *const sAnims_LeaderMaylene[] ={
    sAnim_GeneralFrame0,
};
static const union AnimCmd *const sAnims_LeaderCrasherWake[] ={
    sAnim_GeneralFrame0,
};
static const union AnimCmd *const sAnims_LeaderFantina[] ={
    sAnim_GeneralFrame0,
};
static const union AnimCmd *const sAnims_LeaderByron[] ={
    sAnim_GeneralFrame0,
};
static const union AnimCmd *const sAnims_LeaderCandice[] ={
    sAnim_GeneralFrame0,
};
static const union AnimCmd *const sAnims_LeaderVolkner[] ={
    sAnim_GeneralFrame0,
};
static const union AnimCmd *const sAnims_RedRby[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_DawnPt[] ={
    sAnim_GeneralFrame0,
};
// ROWENEWTRN-END animdefs
...
// CHARMODE-SPRITES-START front-anims (generated by tools/character_mode/import_sprites.py)
	[TRAINER_PIC_BLUE] = sAnims_RubySapphireMay,
	[TRAINER_PIC_LANCE] = sAnims_RubySapphireMay,
	[TRAINER_PIC_LORELEI] = sAnims_RubySapphireMay,
	[TRAINER_PIC_BRUNO] = sAnims_RubySapphireMay,
	[TRAINER_PIC_AGATHA] = sAnims_RubySapphireMay,
	[TRAINER_PIC_KOGA] = sAnims_RubySapphireMay,
	[TRAINER_PIC_BROCK] = sAnims_RubySapphireMay,
	[TRAINER_PIC_MISTY] = sAnims_RubySapphireMay,
	[TRAINER_PIC_LT_SURGE] = sAnims_RubySapphireMay,
	[TRAINER_PIC_ERIKA] = sAnims_RubySapphireMay,
	[TRAINER_PIC_SABRINA] = sAnims_RubySapphireMay,
	[TRAINER_PIC_BLAINE] = sAnims_RubySapphireMay,
	[TRAINER_PIC_GIOVANNI] = sAnims_RubySapphireMay,
	[TRAINER_PIC_LUCAS] = sAnims_RubySapphireMay,
	[TRAINER_PIC_DAWN] = sAnims_RubySapphireMay,
	[TRAINER_PIC_BARRY] = sAnims_RubySapphireMay,
	[TRAINER_PIC_CYNTHIA] = sAnims_RubySapphireMay,
	[TRAINER_PIC_ROARK] = sAnims_RubySapphireMay,
	[TRAINER_PIC_GARDENIA] = sAnims_RubySapphireMay,
	[TRAINER_PIC_MAYLENE] = sAnims_RubySapphireMay,
	[TRAINER_PIC_CRASHER_WAKE] = sAnims_RubySapphireMay,
	[TRAINER_PIC_FANTINA] = sAnims_RubySapphireMay,
	[TRAINER_PIC_BYRON] = sAnims_RubySapphireMay,
	[TRAINER_PIC_CANDICE] = sAnims_RubySapphireMay,
	[TRAINER_PIC_VOLKNER] = sAnims_RubySapphireMay,
	[TRAINER_PIC_BERTHA] = sAnims_RubySapphireMay,
	[TRAINER_PIC_LUCIAN] = sAnims_RubySapphireMay,
	[TRAINER_PIC_CYRUS] = sAnims_RubySapphireMay,
	...
	[TRAINER_PIC_ETHAN] = sAnims_RubySapphireMay,
	[TRAINER_PIC_KRIS] = sAnims_RubySapphireMay,
...
// ROWENEWTRN-START animptr (generated by tools/character_mode/port_2x_new_trainers.py)
    [TRAINER_PIC_HILDA] = sAnims_Hilda,
    ...
    [TRAINER_PIC_LEADER_ROARK] = sAnims_LeaderRoark,
    [TRAINER_PIC_LEADER_GARDENIA] = sAnims_LeaderGardenia,
    [TRAINER_PIC_LEADER_MAYLENE] = sAnims_LeaderMaylene,
    [TRAINER_PIC_LEADER_CRASHER_WAKE] = sAnims_LeaderCrasherWake,
    [TRAINER_PIC_LEADER_FANTINA] = sAnims_LeaderFantina,
    [TRAINER_PIC_LEADER_BYRON] = sAnims_LeaderByron,
    [TRAINER_PIC_LEADER_CANDICE] = sAnims_LeaderCandice,
    [TRAINER_PIC_LEADER_VOLKNER] = sAnims_LeaderVolkner,
    [TRAINER_PIC_RED_RBY] = sAnims_RedRby,
    ...
    [TRAINER_PIC_DAWN_PT] = sAnims_DawnPt,
// ROWENEWTRN-END animptr
};
