const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    // Legends: Arceus. Without these four rows the array entries are NULL and
    // MonTryLearningNewMove's unbounded u8 scan hangs the game.
...
// GEN9-PORT-START learnptrs (generated by tools/character_mode/port_gen9.py)
    ...
    [SPECIES_OINKOLOGNE] = sOinkologneMLevelUpLearnset,
...
// GEN9-PORT-END learnptrs
// ROWEMEGA-PORT-START learnptrs (generated by tools/character_mode/port_rowe_megas.py)
    [SPECIES_ABSOL_MEGA_Z] = sAbsolLevelUpLearnset,
    [SPECIES_ALCREMIE_MEGA] = sAlcremieLevelUpLearnset,
    [SPECIES_APPLETUN_MEGA] = sAppletunLevelUpLearnset,
    ...
    [SPECIES_BLASTOISE_MEGA_G] = sBlastoiseLevelUpLearnset,
    ...
    [SPECIES_CLEFABLE_MEGA_REDUX] = sClefableLevelUpLearnset,
    [SPECIES_CLODSIRE_MEGA] = sClodsireLevelUpLearnset,
    ...
    [SPECIES_SAMUROTT_HISUI_MEGA] = sBulbasaurLevelUpLearnset,
    ...
    [SPECIES_SLOWBRO_GALAR_MEGA] = sBulbasaurLevelUpLearnset,
    [SPECIES_SLOWKING_GALAR_MEGA] = sBulbasaurLevelUpLearnset,
    ...
    [SPECIES_STARMIE_MEGA_REDUX] = sStarmieLevelUpLearnset,
    [SPECIES_TATSUGIRI_MEGA_CURLY] = sTatsugiriLevelUpLearnset,
    ...
    [SPECIES_TOXTRICITY_MEGA_LOW_KEY] = sToxtricityLowKeyLevelUpLearnset,
    [SPECIES_TSAREENA_MEGA] = sTsareenaLevelUpLearnset,
    [SPECIES_TYPHLOSION_HISUI_MEGA] = sBulbasaurLevelUpLearnset,
    [SPECIES_TYPHLOSION_MEGA] = sTyphlosionLevelUpLearnset,
    [SPECIES_URSHIFU_MEGA_RAPID_STRIKE] = sBulbasaurLevelUpLearnset,
    [SPECIES_URSHIFU_MEGA_SINGLE_STRIKE] = sUrshifuLevelUpLearnset,
    [SPECIES_VENUSAUR_MEGA_G] = sVenusaurLevelUpLearnset,
...
// ROWEMEGA-PORT-END learnptrs
// ROWESPEC-PORT-START learnptrs (generated by tools/character_mode/port_2x_species.py)
    [SPECIES_BASCULIN_WHITE_STRIPED] = sBasculinLevelUpLearnset,
    [SPECIES_DARMANITAN_GALAR_ZEN] = sDarmanitanLevelUpLearnset,
    [SPECIES_DIALGA_ORIGIN] = sDialgaLevelUpLearnset,
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] = sDudunsparceLevelUpLearnset,
    [SPECIES_FLOETTE_ETERNAL_MEGA] = sFloetteLevelUpLearnset,
    [SPECIES_FLOETTE_MEGA] = sFloetteLevelUpLearnset,
    [SPECIES_MAUSHOLD_FOUR] = sMausholdLevelUpLearnset,
    [SPECIES_MEOWSTIC_MEGA_F] = sMeowsticLevelUpLearnset,
    ...
    [SPECIES_OINKOLOGNE_F] = sOinkologneMLevelUpLearnset,
    ...
    [SPECIES_SANDSLASH_MEGA_ALOLA] = sSandslashLevelUpLearnset,
    ...
    [SPECIES_TATSUGIRI_MEGA_DROOPY] = sTatsugiriLevelUpLearnset,
    [SPECIES_TATSUGIRI_MEGA_STRETCHY] = sTatsugiriLevelUpLearnset,
    [SPECIES_TATSUGIRI_STRETCHY] = sTatsugiriLevelUpLearnset,
    [SPECIES_TAUROS_PALDEA_AQUA] = sTaurosLevelUpLearnset,
    [SPECIES_TAUROS_PALDEA_BLAZE] = sTaurosLevelUpLearnset,
    [SPECIES_TAUROS_PALDEA_COMBAT] = sTaurosLevelUpLearnset,
    [SPECIES_TERAPAGOS_STELLAR] = sTerapagosLevelUpLearnset,
    [SPECIES_VANILLUXE_MEGA] = sVanilluxeLevelUpLearnset,
    [SPECIES_WOOPER_PALDEA] = sWooperLevelUpLearnset,
// ROWESPEC-PORT-END learnptrs
};
