...
// The four Legends: Arceus species that already had base stats, dex numbers and
// pre-evolution rows in this tree but NO learnset -- so gLevelUpLearnsets was a
// NULL pointer for them and MonTryLearningNewMove's unbounded u8 scan hung the
// game. Copied verbatim from RoweRepo-donor. The commented-out rows are the
// donor's own; they are kept as they stand rather than enabled.
// Guarded by tools/check_species_tables.py.
...
// GEN9-PORT-START learnsets (generated by tools/character_mode/port_gen9.py)
