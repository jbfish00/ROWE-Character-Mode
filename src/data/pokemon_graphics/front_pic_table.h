...
// GEN9-PORT-START fronts (generated by tools/character_mode/port_gen9.py)
...
// GEN9-PORT-END fronts
// ROWESPEC-PORT-START front (generated by tools/character_mode/port_2x_species.py)
    SPECIES_SPRITE(BASCULIN_WHITE_STRIPED, gMonFrontPic_Basculin_Whitestriped),
    SPECIES_SPRITE(DARMANITAN_GALAR_ZEN, gMonFrontPic_DarmanitanGalarZen),
    SPECIES_SPRITE(DIALGA_ORIGIN, gMonFrontPic_Dialga),
    SPECIES_SPRITE(DUDUNSPARCE_THREE_SEGMENT, gMonFrontPic_Dudunsparce),
    SPECIES_SPRITE(FLOETTE_ETERNAL_MEGA, gMonFrontPic_Floette),
    SPECIES_SPRITE(FLOETTE_MEGA, gMonFrontPic_Floette_Mega),
    SPECIES_SPRITE(MAUSHOLD_FOUR, gMonFrontPic_Maushold),
    SPECIES_SPRITE(MEOWSTIC_MEGA_F, gMonFrontPic_Meowstic_Mega_Female),
    SPECIES_SPRITE(MINIOR_METEOR, gMonFrontPic_Minior),
    SPECIES_SPRITE(OGERPON_CORNERSTONE, gMonFrontPic_Ogerpon),
    SPECIES_SPRITE(OGERPON_HEARTHFLAME, gMonFrontPic_Ogerpon),
    SPECIES_SPRITE(OGERPON_WELLSPRING, gMonFrontPic_Ogerpon),
    SPECIES_SPRITE(OINKOLOGNE_F, gMonFrontPic_Oinkologne),
    SPECIES_SPRITE(PALAFIN_HERO, gMonFrontPic_Palafin),
    SPECIES_SPRITE(PALKIA_ORIGIN, gMonFrontPic_Palkia),
    SPECIES_SPRITE(POLTCHAGEIST_ARTISAN, gMonFrontPic_Poltchageist),
    SPECIES_SPRITE(SANDSLASH_MEGA_ALOLA, gMonFrontPic_Sandslash_Mega_Alolan),
    SPECIES_SPRITE(SHEDINJA_MEGA, gMonFrontPic_Shedinja_Mega),
    SPECIES_SPRITE(SINISTCHA_MASTERPIECE, gMonFrontPic_Sinistcha),
    SPECIES_SPRITE(SQUAWKABILLY_BLUE, gMonFrontPic_Squawkabilly),
    SPECIES_SPRITE(SQUAWKABILLY_GREEN, gMonFrontPic_Squawkabilly),
    SPECIES_SPRITE(SQUAWKABILLY_WHITE, gMonFrontPic_Squawkabilly),
    SPECIES_SPRITE(SQUAWKABILLY_YELLOW, gMonFrontPic_Squawkabilly),
    SPECIES_SPRITE(TATSUGIRI_CURLY, gMonFrontPic_Tatsugiri),
    SPECIES_SPRITE(TATSUGIRI_DROOPY, gMonFrontPic_Tatsugiri),
    SPECIES_SPRITE(TATSUGIRI_MEGA_DROOPY, gMonFrontPic_Tatsugiri_Mega_Droopy),
    SPECIES_SPRITE(TATSUGIRI_MEGA_STRETCHY, gMonFrontPic_Tatsugiri_Mega_Stretchy),
    SPECIES_SPRITE(TATSUGIRI_STRETCHY, gMonFrontPic_Tatsugiri),
    SPECIES_SPRITE(TAUROS_PALDEA_AQUA, gMonFrontPic_Tauros),
    SPECIES_SPRITE(TAUROS_PALDEA_BLAZE, gMonFrontPic_Tauros),
    SPECIES_SPRITE(TAUROS_PALDEA_COMBAT, gMonFrontPic_Tauros_Paldean_Combat_Breed),
    SPECIES_SPRITE(TERAPAGOS_STELLAR, gMonFrontPic_Ogerpon),
    SPECIES_SPRITE(VANILLUXE_MEGA, gMonFrontPic_Vanilluxe_Mega),
    SPECIES_SPRITE(WOOPER_PALDEA, gMonFrontPic_Wooper),
// ROWESPEC-PORT-END front
// ROWEGFX-START front (generated by tools/character_mode/fix_species_graphics.py)
    SPECIES_SPRITE(WYRDEER, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(KLEAVOR, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(URSALUNA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(BASCULEGION, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SNEASLER, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(OVERQWIL, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ENAMORUS, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(GROWLITHE_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ARCANINE_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(VOLTORB_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ELECTRODE_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(TYPHLOSION_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SNEASEL_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SAMUROTT_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(LILLIGANT_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ZORUA_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ZOROARK_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(BRAVIARY_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SLIGGOO_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(GOODRA_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(AVALUGG_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(DECIDUEYE_HUSIAN, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ABSOL_MEGA_Z, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ALCREMIE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(APPLETUN_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ARBOK_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(BARBARACLE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(BAXCALIBUR_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(BLASTOISE_MEGA_G, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(BRELOOM_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(BUTTERFREE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CENTISKORCH_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CHANDELURE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CHESNAUGHT_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CHIMECHO_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CINDERACE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CLEFABLE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CLEFABLE_MEGA_REDUX, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CLODSIRE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(COALOSSAL_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CORVIKNIGHT_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CRABOMINABLE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CROBAT_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(DARKRAI_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(DELPHOX_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(DEWGONG_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(DRAGALGE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(DRAGONITE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(DRAMPA_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(DREDNAW_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(EELEKTROSS_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(EMBOAR_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(EXCADRILL_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(FALINKS_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(FERALIGATR_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(FLAPPLE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(FLYGON_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(FROSLASS_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(GARBODOR_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(GARCHOMP_MEGA_Z, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(GLIMMORA_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(GOLISOPOD_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(GOLURK_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(GRENINJA_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(GRIMMSNARL_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(HATTERENE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(HAWLUCHA_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(HEATRAN_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(INTELEON_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(KINGLER_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(KROOKODILE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(LANTURN_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(LAPRAS_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(LUCARIO_MEGA_Z, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(LUXRAY_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(MACHAMP_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(MAGEARNA_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(MALAMAR_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(MEGANIUM_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(MELMETAL_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(MEOWSTIC_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(MILOTIC_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ORBEETLE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(PYROAR_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(QUAGSIRE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(RAICHU_MEGA_X, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(RAICHU_MEGA_Y, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(RIBOMBEE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(RILLABOOM_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SAMUROTT_HISUI_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SAMUROTT_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SANDACONDA_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SANDSLASH_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SCOLIPEDE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SCOVILLAIN_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SCRAFTY_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SERPERIOR_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SHUCKLE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SKARMORY_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SLOWBRO_GALAR_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SLOWKING_GALAR_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SLOWKING_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(SNORLAX_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(STARAPTOR_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(STARMIE_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(STARMIE_MEGA_REDUX, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(TATSUGIRI_MEGA_CURLY, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(TINKATON_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(TOUCANNON_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(TOXTRICITY_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(TOXTRICITY_MEGA_LOW_KEY, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(TSAREENA_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(TYPHLOSION_HISUI_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(TYPHLOSION_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(URSHIFU_MEGA_RAPID_STRIKE, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(URSHIFU_MEGA_SINGLE_STRIKE, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(VENUSAUR_MEGA_G, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(VICTREEBEL_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ZERAORA_MEGA, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(ZYGARDE_MEGA, gMonFrontPic_CircledQuestionMark),
// ROWEGFX-END front
};
...
// ROWEMEGA-PORT-START fronts (generated by tools/character_mode/port_rowe_megas.py)
    SPECIES_SPRITE(ABSOL_MEGA_Z, gMonFrontPic_AbsolMegaZ),
    SPECIES_SPRITE(ALCREMIE_MEGA, gMonFrontPic_AlcremieMega),
    SPECIES_SPRITE(APPLETUN_MEGA, gMonFrontPic_AppletunMega),
    ...
    SPECIES_SPRITE(BLASTOISE_MEGA_G, gMonFrontPic_BlastoiseMegaG),
    ...
    SPECIES_SPRITE(CLEFABLE_MEGA_REDUX, gMonFrontPic_ClefableMegaRedux),
    SPECIES_SPRITE(CLODSIRE_MEGA, gMonFrontPic_ClodsireMega),
    ...
    SPECIES_SPRITE(MELMETAL_MEGA, gMonFrontPic_MelmetalMega),
    ...
    SPECIES_SPRITE(RIBOMBEE_MEGA, gMonFrontPic_RibombeeMega),
    SPECIES_SPRITE(RILLABOOM_MEGA, gMonFrontPic_RillaboomMega),
    SPECIES_SPRITE(SAMUROTT_HISUI_MEGA, gMonFrontPic_SamurottHisuiMega),
    ...
    SPECIES_SPRITE(SLOWBRO_GALAR_MEGA, gMonFrontPic_SlowbroGalarMega),
    SPECIES_SPRITE(SLOWKING_GALAR_MEGA, gMonFrontPic_SlowkingGalarMega),
    ...
    SPECIES_SPRITE(STARMIE_MEGA_REDUX, gMonFrontPic_StarmieMegaRedux),
    SPECIES_SPRITE(TATSUGIRI_MEGA_CURLY, gMonFrontPic_TatsugiriMegaCurly),
    ...
    SPECIES_SPRITE(TOXTRICITY_MEGA_LOW_KEY, gMonFrontPic_ToxtricityMegaLowKey),
    SPECIES_SPRITE(TSAREENA_MEGA, gMonFrontPic_TsareenaMega),
    SPECIES_SPRITE(TYPHLOSION_HISUI_MEGA, gMonFrontPic_TyphlosionHisuiMega),
    SPECIES_SPRITE(TYPHLOSION_MEGA, gMonFrontPic_TyphlosionMega),
    SPECIES_SPRITE(URSHIFU_MEGA_RAPID_STRIKE, gMonFrontPic_UrshifuMegaRapidStrike),
    SPECIES_SPRITE(URSHIFU_MEGA_SINGLE_STRIKE, gMonFrontPic_UrshifuMegaSingleStrike),
    SPECIES_SPRITE(VENUSAUR_MEGA_G, gMonFrontPic_VenusaurMegaG),
