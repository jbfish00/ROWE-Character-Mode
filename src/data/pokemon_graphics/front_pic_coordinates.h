const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    // gMonFrontPic_CircledQuestionMark -- the same 64x64 placeholder
...
// GEN9-PORT-START frontcoords (generated by tools/character_mode/port_gen9.py)
    [SPECIES_SPRIGATITO] =
    {
        .size = 0x88,
        .y_offset = 8,
...
// GEN9-PORT-END frontcoords
// ROWEMEGA-PORT-START frontcoords (generated by tools/character_mode/port_rowe_megas.py)
...
// ROWEMEGA-PORT-END frontcoords
// ROWESPEC-PORT-START fcoords (generated by tools/character_mode/port_2x_species.py)
    [SPECIES_BASCULIN_WHITE_STRIPED] = {.size = 0, .y_offset = 12},
    [SPECIES_DARMANITAN_GALAR_ZEN] = {.size = 0x68, .y_offset = 2},
    [SPECIES_DIALGA_ORIGIN] = {.size = 0, .y_offset = 0},
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] = {.size = 0, .y_offset = 10},
    [SPECIES_FLOETTE_ETERNAL_MEGA] = {.size = 0x88, .y_offset = 0},
    [SPECIES_FLOETTE_MEGA] = {.size = 0, .y_offset = 0},
    [SPECIES_MAUSHOLD_FOUR] = {.size = 0, .y_offset = 15},
    [SPECIES_MEOWSTIC_MEGA_F] = {.size = 0, .y_offset = 0},
    [SPECIES_MINIOR_METEOR] = {.size = 0x88, .y_offset = 0},
    [SPECIES_OGERPON_CORNERSTONE] = {.size = 0, .y_offset = 1},
    [SPECIES_OGERPON_HEARTHFLAME] = {.size = 0, .y_offset = 1},
    [SPECIES_OGERPON_WELLSPRING] = {.size = 0, .y_offset = 1},
    [SPECIES_OINKOLOGNE_F] = {.size = 0, .y_offset = 7},
    [SPECIES_PALAFIN_HERO] = {.size = 0, .y_offset = 0},
    [SPECIES_PALKIA_ORIGIN] = {.size = 0, .y_offset = 0},
    [SPECIES_POLTCHAGEIST_ARTISAN] = {.size = 0, .y_offset = 7},
    [SPECIES_SANDSLASH_MEGA_ALOLA] = {.size = 0, .y_offset = 0},
    [SPECIES_SHEDINJA_MEGA] = {.size = 0, .y_offset = 0},
    [SPECIES_SINISTCHA_MASTERPIECE] = {.size = 0, .y_offset = 3},
    ...
    [SPECIES_TATSUGIRI_CURLY] = {.size = 0, .y_offset = 14},
    [SPECIES_TATSUGIRI_DROOPY] = {.size = 0, .y_offset = 14},
    [SPECIES_TATSUGIRI_MEGA_DROOPY] = {.size = 0, .y_offset = 0},
    [SPECIES_TATSUGIRI_MEGA_STRETCHY] = {.size = 0, .y_offset = 0},
    [SPECIES_TATSUGIRI_STRETCHY] = {.size = 0, .y_offset = 14},
    [SPECIES_TAUROS_PALDEA_AQUA] = {.size = 0, .y_offset = 5},
    [SPECIES_TAUROS_PALDEA_BLAZE] = {.size = 0, .y_offset = 5},
    [SPECIES_TAUROS_PALDEA_COMBAT] = {.size = 0, .y_offset = 5},
    [SPECIES_TERAPAGOS_STELLAR] = {.size = 0, .y_offset = 0},
    [SPECIES_VANILLUXE_MEGA] = {.size = 0, .y_offset = 0},
    [SPECIES_WOOPER_PALDEA] = {.size = 0x54, .y_offset = 16},
// ROWESPEC-PORT-END fcoords
};
