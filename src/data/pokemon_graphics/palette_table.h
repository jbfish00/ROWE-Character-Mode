...
// GEN9-PORT-START pals (generated by tools/character_mode/port_gen9.py)
...
// GEN9-PORT-END pals
// ROWESPEC-PORT-START pal (generated by tools/character_mode/port_2x_species.py)
    SPECIES_PAL(BASCULIN_WHITE_STRIPED, gMonPalette_Basculin_Whitestriped),
    SPECIES_PAL(DARMANITAN_GALAR_ZEN, gMonPalette_DarmanitanGalarZen),
    SPECIES_PAL(DIALGA_ORIGIN, gMonPalette_Dialga),
    SPECIES_PAL(DUDUNSPARCE_THREE_SEGMENT, gMonPalette_Dudunsparce),
    SPECIES_PAL(FLOETTE_ETERNAL_MEGA, gMonPalette_Floette),
    SPECIES_PAL(FLOETTE_MEGA, gMonPalette_Floette_Mega),
    SPECIES_PAL(MAUSHOLD_FOUR, gMonPalette_Maushold),
    SPECIES_PAL(MEOWSTIC_MEGA_F, gMonPalette_Meowstic_Mega_Female),
    SPECIES_PAL(MINIOR_METEOR, gMonPalette_Minior),
    SPECIES_PAL(OGERPON_CORNERSTONE, gMonPalette_Ogerpon),
    SPECIES_PAL(OGERPON_HEARTHFLAME, gMonPalette_Ogerpon),
    SPECIES_PAL(OGERPON_WELLSPRING, gMonPalette_Ogerpon),
    SPECIES_PAL(OINKOLOGNE_F, gMonPalette_Oinkologne),
    SPECIES_PAL(PALAFIN_HERO, gMonPalette_Palafin),
    SPECIES_PAL(PALKIA_ORIGIN, gMonPalette_Palkia),
    SPECIES_PAL(POLTCHAGEIST_ARTISAN, gMonPalette_Poltchageist),
    SPECIES_PAL(SANDSLASH_MEGA_ALOLA, gMonPalette_Sandslash_Mega_Alolan),
    SPECIES_PAL(SHEDINJA_MEGA, gMonPalette_Shedinja_Mega),
    SPECIES_PAL(SINISTCHA_MASTERPIECE, gMonPalette_Sinistcha),
    SPECIES_PAL(SQUAWKABILLY_BLUE, gMonPalette_Squawkabilly),
    SPECIES_PAL(SQUAWKABILLY_GREEN, gMonPalette_Squawkabilly),
    SPECIES_PAL(SQUAWKABILLY_WHITE, gMonPalette_Squawkabilly),
    SPECIES_PAL(SQUAWKABILLY_YELLOW, gMonPalette_Squawkabilly),
    SPECIES_PAL(TATSUGIRI_CURLY, gMonPalette_Tatsugiri),
    SPECIES_PAL(TATSUGIRI_DROOPY, gMonPalette_Tatsugiri),
    SPECIES_PAL(TATSUGIRI_MEGA_DROOPY, gMonPalette_Tatsugiri_Mega_Droopy),
    SPECIES_PAL(TATSUGIRI_MEGA_STRETCHY, gMonPalette_Tatsugiri_Mega_Stretchy),
    SPECIES_PAL(TATSUGIRI_STRETCHY, gMonPalette_Tatsugiri),
    SPECIES_PAL(TAUROS_PALDEA_AQUA, gMonPalette_Tauros),
    SPECIES_PAL(TAUROS_PALDEA_BLAZE, gMonPalette_Tauros),
    SPECIES_PAL(TAUROS_PALDEA_COMBAT, gMonPalette_Tauros_Paldean_Combat_Breed),
    SPECIES_PAL(TERAPAGOS_STELLAR, gMonPalette_Ogerpon),
    SPECIES_PAL(VANILLUXE_MEGA, gMonPalette_Vanilluxe_Mega),
    SPECIES_PAL(WOOPER_PALDEA, gMonPalette_Wooper),
// ROWESPEC-PORT-END pal
// ROWEGFX-START pal (generated by tools/character_mode/fix_species_graphics.py)
    SPECIES_PAL(WYRDEER, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(KLEAVOR, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(URSALUNA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(BASCULEGION, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SNEASLER, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(OVERQWIL, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ENAMORUS, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(GROWLITHE_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ARCANINE_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(VOLTORB_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ELECTRODE_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(TYPHLOSION_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SNEASEL_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SAMUROTT_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(LILLIGANT_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ZORUA_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ZOROARK_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(BRAVIARY_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SLIGGOO_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(GOODRA_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(AVALUGG_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(DECIDUEYE_HUSIAN, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ABSOL_MEGA_Z, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ALCREMIE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(APPLETUN_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ARBOK_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(BARBARACLE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(BAXCALIBUR_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(BLASTOISE_MEGA_G, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(BRELOOM_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(BUTTERFREE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CENTISKORCH_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CHANDELURE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CHESNAUGHT_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CHIMECHO_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CINDERACE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CLEFABLE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CLEFABLE_MEGA_REDUX, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CLODSIRE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(COALOSSAL_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CORVIKNIGHT_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CRABOMINABLE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(CROBAT_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(DARKRAI_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(DELPHOX_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(DEWGONG_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(DRAGALGE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(DRAGONITE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(DRAMPA_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(DREDNAW_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(EELEKTROSS_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(EMBOAR_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(EXCADRILL_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(FALINKS_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(FERALIGATR_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(FLAPPLE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(FLYGON_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(FROSLASS_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(GARBODOR_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(GARCHOMP_MEGA_Z, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(GLIMMORA_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(GOLISOPOD_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(GOLURK_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(GRENINJA_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(GRIMMSNARL_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(HATTERENE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(HAWLUCHA_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(HEATRAN_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(INTELEON_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(KINGLER_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(KROOKODILE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(LANTURN_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(LAPRAS_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(LUCARIO_MEGA_Z, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(LUXRAY_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(MACHAMP_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(MAGEARNA_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(MALAMAR_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(MEGANIUM_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(MELMETAL_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(MEOWSTIC_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(MILOTIC_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ORBEETLE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(PYROAR_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(QUAGSIRE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(RAICHU_MEGA_X, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(RAICHU_MEGA_Y, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(RIBOMBEE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(RILLABOOM_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SAMUROTT_HISUI_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SAMUROTT_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SANDACONDA_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SANDSLASH_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SCOLIPEDE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SCOVILLAIN_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SCRAFTY_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SERPERIOR_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SHUCKLE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SKARMORY_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SLOWBRO_GALAR_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SLOWKING_GALAR_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SLOWKING_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(SNORLAX_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(STARAPTOR_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(STARMIE_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(STARMIE_MEGA_REDUX, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(TATSUGIRI_MEGA_CURLY, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(TINKATON_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(TOUCANNON_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(TOXTRICITY_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(TOXTRICITY_MEGA_LOW_KEY, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(TSAREENA_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(TYPHLOSION_HISUI_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(TYPHLOSION_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(URSHIFU_MEGA_RAPID_STRIKE, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(URSHIFU_MEGA_SINGLE_STRIKE, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(VENUSAUR_MEGA_G, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(VICTREEBEL_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ZERAORA_MEGA, gMonPalette_CircledQuestionMark),
    SPECIES_PAL(ZYGARDE_MEGA, gMonPalette_CircledQuestionMark),
// ROWEGFX-END pal
};
...
// ROWEMEGA-PORT-START pals (generated by tools/character_mode/port_rowe_megas.py)
    SPECIES_PAL(ABSOL_MEGA_Z, gMonPalette_AbsolMegaZ),
    SPECIES_PAL(ALCREMIE_MEGA, gMonPalette_AlcremieMega),
    SPECIES_PAL(APPLETUN_MEGA, gMonPalette_AppletunMega),
    ...
    SPECIES_PAL(BLASTOISE_MEGA_G, gMonPalette_BlastoiseMegaG),
    ...
    SPECIES_PAL(CLEFABLE_MEGA_REDUX, gMonPalette_ClefableMegaRedux),
    SPECIES_PAL(CLODSIRE_MEGA, gMonPalette_ClodsireMega),
    ...
    SPECIES_PAL(RIBOMBEE_MEGA, gMonPalette_RibombeeMega),
    SPECIES_PAL(RILLABOOM_MEGA, gMonPalette_RillaboomMega),
    SPECIES_PAL(SAMUROTT_HISUI_MEGA, gMonPalette_SamurottHisuiMega),
    ...
    SPECIES_PAL(SLOWBRO_GALAR_MEGA, gMonPalette_SlowbroGalarMega),
    SPECIES_PAL(SLOWKING_GALAR_MEGA, gMonPalette_SlowkingGalarMega),
    ...
    SPECIES_PAL(STARMIE_MEGA_REDUX, gMonPalette_StarmieMegaRedux),
    SPECIES_PAL(TATSUGIRI_MEGA_CURLY, gMonPalette_TatsugiriMegaCurly),
    ...
    SPECIES_PAL(TOXTRICITY_MEGA_LOW_KEY, gMonPalette_ToxtricityMegaLowKey),
    SPECIES_PAL(TSAREENA_MEGA, gMonPalette_TsareenaMega),
    SPECIES_PAL(TYPHLOSION_HISUI_MEGA, gMonPalette_TyphlosionHisuiMega),
    SPECIES_PAL(TYPHLOSION_MEGA, gMonPalette_TyphlosionMega),
    SPECIES_PAL(URSHIFU_MEGA_RAPID_STRIKE, gMonPalette_UrshifuMegaRapidStrike),
    SPECIES_PAL(URSHIFU_MEGA_SINGLE_STRIKE, gMonPalette_UrshifuMegaSingleStrike),
    SPECIES_PAL(VENUSAUR_MEGA_G, gMonPalette_VenusaurMegaG),
