const struct MonCoords gMonBackPicCoords[] =
{
    ...
    // Legends: Arceus. These four have base stats but no art, so they render
    // gMonBackPic_CircledQuestionMark -- the same 64x64 placeholder
    // [SPECIES_NONE] uses, hence the same coords. A missing row is size 0.
    // When real art lands, replace these with the art's own measurements.
    [SPECIES_WYRDEER] =
    {
        .size = 0x88,
        .y_offset = 0,
...
// GEN9-PORT-START backcoords (generated by tools/character_mode/port_gen9.py)
    [SPECIES_SPRIGATITO] =
    {
        .size = 0x88,
        .y_offset = 7,
...
// GEN9-PORT-END backcoords
// ROWEMEGA-PORT-START backcoords (generated by tools/character_mode/port_rowe_megas.py)
...
// ROWEMEGA-PORT-END backcoords
// ROWESPEC-PORT-START bcoords (generated by tools/character_mode/port_2x_species.py)
    [SPECIES_BASCULIN_WHITE_STRIPED] = {.size = 0, .y_offset = 16},
    [SPECIES_DARMANITAN_GALAR_ZEN] = {.size = 0x88, .y_offset = 1},
    [SPECIES_DIALGA_ORIGIN] = {.size = 0x88, .y_offset = 0},
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] = {.size = 0x88, .y_offset = 0},
    [SPECIES_FLOETTE_ETERNAL_MEGA] = {.size = 0, .y_offset = 0},
    [SPECIES_FLOETTE_MEGA] = {.size = 0x88, .y_offset = 0},
    [SPECIES_MAUSHOLD_FOUR] = {.size = 0x88, .y_offset = 0},
    [SPECIES_MEOWSTIC_MEGA_F] = {.size = 0, .y_offset = 0},
    [SPECIES_MINIOR_METEOR] = {.size = 0x88, .y_offset = 0},
    ...
    [SPECIES_OINKOLOGNE_F] = {.size = 0, .y_offset = 12},
    [SPECIES_PALAFIN_HERO] = {.size = 0x88, .y_offset = 0},
    [SPECIES_PALKIA_ORIGIN] = {.size = 0x88, .y_offset = 0},
    [SPECIES_POLTCHAGEIST_ARTISAN] = {.size = 0x88, .y_offset = 0},
    [SPECIES_SANDSLASH_MEGA_ALOLA] = {.size = 0, .y_offset = 2},
    [SPECIES_SHEDINJA_MEGA] = {.size = 0, .y_offset = 1},
    [SPECIES_SINISTCHA_MASTERPIECE] = {.size = 0x88, .y_offset = 0},
    [SPECIES_SQUAWKABILLY_BLUE] = {.size = 0x88, .y_offset = 0},
    [SPECIES_SQUAWKABILLY_GREEN] = {.size = 0x88, .y_offset = 0},
    [SPECIES_SQUAWKABILLY_WHITE] = {.size = 0x88, .y_offset = 0},
    [SPECIES_SQUAWKABILLY_YELLOW] = {.size = 0x88, .y_offset = 0},
    [SPECIES_TATSUGIRI_CURLY] = {.size = 0x88, .y_offset = 0},
    [SPECIES_TATSUGIRI_DROOPY] = {.size = 0x88, .y_offset = 0},
    [SPECIES_TATSUGIRI_MEGA_DROOPY] = {.size = 0, .y_offset = 9},
    [SPECIES_TATSUGIRI_MEGA_STRETCHY] = {.size = 0, .y_offset = 9},
    [SPECIES_TATSUGIRI_STRETCHY] = {.size = 0x88, .y_offset = 0},
    [SPECIES_TAUROS_PALDEA_AQUA] = {.size = 0x88, .y_offset = 0},
    [SPECIES_TAUROS_PALDEA_BLAZE] = {.size = 0x88, .y_offset = 0},
    [SPECIES_TAUROS_PALDEA_COMBAT] = {.size = 0x88, .y_offset = 0},
    [SPECIES_TERAPAGOS_STELLAR] = {.size = 0x88, .y_offset = 0},
    [SPECIES_VANILLUXE_MEGA] = {.size = 0, .y_offset = 0},
    [SPECIES_WOOPER_PALDEA] = {.size = 0x85, .y_offset = 0},
// ROWESPEC-PORT-END bcoords
};