...
// ROWEMOVE-PORT-START forbidden (generated by tools/character_mode/port_2x_moves.py)
    [MOVE_ALLURING_VOICE] = FALSE,
    [MOVE_WAVE_CRASH] = FALSE,
    [MOVE_GIGATON_HAMMER] = FALSE,
    [MOVE_AQUA_CUTTER] = FALSE,
    [MOVE_AQUA_STEP] = FALSE,
    [MOVE_ARMOR_CANNON] = FALSE,
    [MOVE_AXE_KICK] = FALSE,
    [MOVE_BITTER_BLADE] = FALSE,
    [MOVE_BLAZING_TORQUE] = FALSE,
    [MOVE_BLOOD_MOON] = FALSE,
    [MOVE_BURNING_BULWARK] = FALSE,
    [MOVE_CHILLING_WATER] = FALSE,
    [MOVE_CHILLY_RECEPTION] = FALSE,
    [MOVE_COLLISION_COURSE] = FALSE,
    [MOVE_COMBAT_TORQUE] = FALSE,
    [MOVE_COMEUPPANCE] = FALSE,
    [MOVE_DOODLE] = FALSE,
    [MOVE_DOUBLE_SHOCK] = FALSE,
    [MOVE_DRAGON_CHEER] = FALSE,
    [MOVE_ELECTRO_DRIFT] = FALSE,
    [MOVE_ELECTRO_SHOT] = FALSE,
    [MOVE_FICKLE_BEAM] = FALSE,
    [MOVE_FILLET_AWAY] = FALSE,
    [MOVE_FLOWER_TRICK] = FALSE,
    [MOVE_GLAIVE_RUSH] = FALSE,
    [MOVE_HARD_PRESS] = FALSE,
    [MOVE_HYDRO_STEAM] = FALSE,
    [MOVE_HYPER_DRILL] = FALSE,
    [MOVE_ICE_SPINNER] = FALSE,
    [MOVE_IVY_CUDGEL] = FALSE,
    [MOVE_JET_PUNCH] = FALSE,
    [MOVE_KOWTOW_CLEAVE] = FALSE,
    [MOVE_LAST_RESPECTS] = FALSE,
    [MOVE_LUMINA_CRASH] = FALSE,
    [MOVE_MAGICAL_TORQUE] = FALSE,
    [MOVE_MAKE_IT_RAIN] = FALSE,
    [MOVE_MALIGNANT_CHAIN] = FALSE,
    [MOVE_MATCHA_GOTCHA] = FALSE,
    [MOVE_MIGHTY_CLEAVE] = FALSE,
    [MOVE_MORTAL_SPIN] = FALSE,
    [MOVE_NOXIOUS_TORQUE] = FALSE,
    [MOVE_ORDER_UP] = FALSE,
    [MOVE_POPULATION_BOMB] = FALSE,
    [MOVE_POUNCE] = FALSE,
    [MOVE_PSYBLADE] = FALSE,
    [MOVE_PSYCHIC_NOISE] = FALSE,
    [MOVE_RAGE_FIST] = FALSE,
    [MOVE_RAGING_BULL] = FALSE,
    [MOVE_REVIVAL_BLESSING] = FALSE,
    [MOVE_RUINATION] = FALSE,
    [MOVE_SALT_CURE] = FALSE,
    [MOVE_SHED_TAIL] = FALSE,
    [MOVE_SILK_TRAP] = FALSE,
    [MOVE_SNOWSCAPE] = FALSE,
    [MOVE_SPICY_EXTRACT] = FALSE,
    [MOVE_SPIN_OUT] = FALSE,
    [MOVE_SUPERCELL_SLAM] = FALSE,
    [MOVE_SYRUP_BOMB] = FALSE,
    [MOVE_TACHYON_CUTTER] = FALSE,
    [MOVE_TEMPER_FLARE] = FALSE,
    [MOVE_TERA_BLAST] = FALSE,
    [MOVE_TERA_STARSTORM] = FALSE,
    [MOVE_THUNDERCLAP] = FALSE,
    [MOVE_TIDY_UP] = FALSE,
    [MOVE_TRAILBLAZE] = FALSE,
    [MOVE_TRIPLE_DIVE] = FALSE,
    [MOVE_TWIN_BEAM] = FALSE,
    [MOVE_UPPER_HAND] = FALSE,
    [MOVE_WICKED_TORQUE] = FALSE,
    ...
    [MOVE_BITTER_MALICE] = FALSE,
    [MOVE_BLEAKWIND_STORM] = FALSE,
    [MOVE_CEASELESS_EDGE] = FALSE,
    [MOVE_CHLOROBLAST] = FALSE,
    [MOVE_DIRE_CLAW] = FALSE,
    [MOVE_ESPER_WING] = FALSE,
    [MOVE_HEADLONG_RUSH] = FALSE,
    [MOVE_INFERNAL_PARADE] = FALSE,
    [MOVE_LUNAR_BLESSING] = FALSE,
    [MOVE_MOUNTAIN_GALE] = FALSE,
    [MOVE_MYSTICAL_POWER] = FALSE,
    [MOVE_POWER_SHIFT] = FALSE,
    [MOVE_PSYSHIELD_BASH] = FALSE,
    [MOVE_SANDSEAR_STORM] = FALSE,
    [MOVE_SHELTER] = FALSE,
    [MOVE_SPRINGTIDE_STORM] = FALSE,
    [MOVE_STONE_AXE] = FALSE,
    [MOVE_TAKE_HEART] = FALSE,
    [MOVE_TRIPLE_ARROWS] = FALSE,
    [MOVE_VICTORY_DANCE] = FALSE,
    [MOVE_WILDBOLT_STORM] = FALSE,
    [MOVE_10000000_VOLT_THUNDERBOLT] = FALSE,
    [MOVE_ACID_DOWNPOUR] = FALSE,
    [MOVE_ALL_OUT_PUMMELING] = FALSE,
    [MOVE_BLACK_HOLE_ECLIPSE] = FALSE,
    [MOVE_BLOOM_DOOM] = FALSE,
    [MOVE_BREAKNECK_BLITZ] = FALSE,
    [MOVE_CATASTROPIKA] = FALSE,
    [MOVE_CLANGOROUS_SOULBLAZE] = FALSE,
    [MOVE_CONTINENTAL_CRUSH] = FALSE,
    [MOVE_CORKSCREW_CRASH] = FALSE,
    [MOVE_DEVASTATING_DRAKE] = FALSE,
    [MOVE_EXTREME_EVOBOOST] = FALSE,
    [MOVE_GENESIS_SUPERNOVA] = FALSE,
    [MOVE_GIGAVOLT_HAVOC] = FALSE,
    [MOVE_GUARDIAN_OF_ALOLA] = FALSE,
    [MOVE_HYDRO_VORTEX] = FALSE,
    [MOVE_INFERNO_OVERDRIVE] = FALSE,
    [MOVE_LETS_SNUGGLE_FOREVER] = FALSE,
    [MOVE_LIGHT_THAT_BURNS_THE_SKY] = FALSE,
    [MOVE_MALICIOUS_MOONSAULT] = FALSE,
    [MOVE_MENACING_MOONRAZE_MAELSTROM] = FALSE,
    [MOVE_NEVER_ENDING_NIGHTMARE] = FALSE,
    [MOVE_OCEANIC_OPERETTA] = FALSE,
    [MOVE_PULVERIZING_PANCAKE] = FALSE,
    [MOVE_SAVAGE_SPIN_OUT] = FALSE,
    [MOVE_SEARING_SUNRAZE_SMASH] = FALSE,
    [MOVE_SHATTERED_PSYCHE] = FALSE,
    [MOVE_SINISTER_ARROW_RAID] = FALSE,
    [MOVE_SOUL_STEALING_7_STAR_STRIKE] = FALSE,
    [MOVE_SPLINTERED_STORMSHARDS] = FALSE,
    [MOVE_STOKED_SPARKSURFER] = FALSE,
    [MOVE_SUBZERO_SLAMMER] = FALSE,
    [MOVE_SUPERSONIC_SKYSTRIKE] = FALSE,
    [MOVE_TECTONIC_RAGE] = FALSE,
    [MOVE_TWINKLE_TACKLE] = FALSE,
    [MOVE_MAX_AIRSTREAM] = FALSE,
    [MOVE_MAX_DARKNESS] = FALSE,
    [MOVE_MAX_FLARE] = FALSE,
    [MOVE_MAX_FLUTTERBY] = FALSE,
    [MOVE_MAX_GEYSER] = FALSE,
    [MOVE_MAX_GUARD] = FALSE,
    [MOVE_MAX_HAILSTORM] = FALSE,
    [MOVE_MAX_KNUCKLE] = FALSE,
    [MOVE_MAX_LIGHTNING] = FALSE,
    [MOVE_MAX_MINDSTORM] = FALSE,
    [MOVE_MAX_OOZE] = FALSE,
    [MOVE_MAX_OVERGROWTH] = FALSE,
    [MOVE_MAX_PHANTASM] = FALSE,
    [MOVE_MAX_QUAKE] = FALSE,
    [MOVE_MAX_ROCKFALL] = FALSE,
    [MOVE_MAX_STARFALL] = FALSE,
    [MOVE_MAX_STEELSPIKE] = FALSE,
    [MOVE_MAX_STRIKE] = FALSE,
    [MOVE_MAX_WYRMWIND] = FALSE,
    [MOVE_G_MAX_BEFUDDLE] = FALSE,
    [MOVE_G_MAX_CANNONADE] = FALSE,
    [MOVE_G_MAX_CENTIFERNO] = FALSE,
    [MOVE_G_MAX_CHI_STRIKE] = FALSE,
    [MOVE_G_MAX_CUDDLE] = FALSE,
    [MOVE_G_MAX_DEPLETION] = FALSE,
    [MOVE_G_MAX_DRUM_SOLO] = FALSE,
    [MOVE_G_MAX_FINALE] = FALSE,
    [MOVE_G_MAX_FIREBALL] = FALSE,
    [MOVE_G_MAX_FOAM_BURST] = FALSE,
    [MOVE_G_MAX_GOLD_RUSH] = FALSE,
    [MOVE_G_MAX_GRAVITAS] = FALSE,
    [MOVE_G_MAX_HYDROSNIPE] = FALSE,
    [MOVE_G_MAX_MALODOR] = FALSE,
    [MOVE_G_MAX_MELTDOWN] = FALSE,
    [MOVE_G_MAX_ONE_BLOW] = FALSE,
    [MOVE_G_MAX_RAPID_FLOW] = FALSE,
    [MOVE_G_MAX_REPLENISH] = FALSE,
    [MOVE_G_MAX_RESONANCE] = FALSE,
    [MOVE_G_MAX_SANDBLAST] = FALSE,
    [MOVE_G_MAX_SMITE] = FALSE,
    [MOVE_G_MAX_SNOOZE] = FALSE,
    [MOVE_G_MAX_STEELSURGE] = FALSE,
    [MOVE_G_MAX_STONESURGE] = FALSE,
    [MOVE_G_MAX_STUN_SHOCK] = FALSE,
    [MOVE_G_MAX_SWEETNESS] = FALSE,
    [MOVE_G_MAX_TARTNESS] = FALSE,
    [MOVE_G_MAX_TERROR] = FALSE,
    [MOVE_G_MAX_VINE_LASH] = FALSE,
    [MOVE_G_MAX_VOLCALITH] = FALSE,
    [MOVE_G_MAX_VOLT_CRASH] = FALSE,
    [MOVE_G_MAX_WILDFIRE] = FALSE,
    [MOVE_G_MAX_WIND_RAGE] = FALSE,
    [MOVE_PLACEHOLDER] = FALSE,
// ROWEMOVE-PORT-END forbidden
};
...
static void Cmd_setmultihitcounter(void)
{
	...
	switch(GetFormSpeciesId(gBattleMons[gBattlerAttacker].species, gBattleMons[gBattlerAttacker].formId)){
		...
		case SPECIES_OVERQWIL:
			if(gCurrentMove == MOVE_PIN_MISSILE && FlagGet(FLAG_BADGE08_GET))
				gMultiHitCounter = 4;
		break;
...
// ROWEMEGA-PORT-START catchrevert (generated by tools/character_mode/port_rowe_megas.py)
        case SPECIES_ABSOL_MEGA_Z:
        case SPECIES_ALCREMIE_MEGA:
        case SPECIES_APPLETUN_MEGA:
        case SPECIES_ARBOK_MEGA:
        case SPECIES_BARBARACLE_MEGA:
        case SPECIES_BAXCALIBUR_MEGA:
        case SPECIES_BLASTOISE_MEGA_G:
        ...
        case SPECIES_CLEFABLE_MEGA_REDUX:
        case SPECIES_CLODSIRE_MEGA:
        case SPECIES_COALOSSAL_MEGA:
        case SPECIES_CORVIKNIGHT_MEGA:
        case SPECIES_CRABOMINABLE_MEGA:
        ...
        case SPECIES_STARMIE_MEGA_REDUX:
        case SPECIES_TATSUGIRI_MEGA_CURLY:
