...
// GEN9-PORT-START icontable (generated by tools/character_mode/port_gen9.py)
...
// GEN9-PORT-END icontable
// ROWEMEGA-PORT-START icontable (generated by tools/character_mode/port_rowe_megas.py)
    [SPECIES_ABSOL_MEGA_Z] = gMonIcon_AbsolMegaZ,
    [SPECIES_ALCREMIE_MEGA] = gMonIcon_AlcremieMega,
    [SPECIES_APPLETUN_MEGA] = gMonIcon_AppletunMega,
    ...
    [SPECIES_BLASTOISE_MEGA_G] = gMonIcon_BlastoiseMegaG,
    ...
    [SPECIES_CLEFABLE_MEGA_REDUX] = gMonIcon_ClefableMegaRedux,
    [SPECIES_CLODSIRE_MEGA] = gMonIcon_ClodsireMega,
    ...
    [SPECIES_RIBOMBEE_MEGA] = gMonIcon_RibombeeMega,
    [SPECIES_RILLABOOM_MEGA] = gMonIcon_RillaboomMega,
    [SPECIES_SAMUROTT_HISUI_MEGA] = gMonIcon_SamurottHisuiMega,
    ...
    [SPECIES_SLOWBRO_GALAR_MEGA] = gMonIcon_SlowbroGalarMega,
    [SPECIES_SLOWKING_GALAR_MEGA] = gMonIcon_SlowkingGalarMega,
    ...
    [SPECIES_STARMIE_MEGA_REDUX] = gMonIcon_StarmieMegaRedux,
    [SPECIES_TATSUGIRI_MEGA_CURLY] = gMonIcon_TatsugiriMegaCurly,
    ...
    [SPECIES_TOXTRICITY_MEGA_LOW_KEY] = gMonIcon_ToxtricityMegaLowKey,
    [SPECIES_TSAREENA_MEGA] = gMonIcon_TsareenaMega,
    [SPECIES_TYPHLOSION_HISUI_MEGA] = gMonIcon_TyphlosionHisuiMega,
    [SPECIES_TYPHLOSION_MEGA] = gMonIcon_TyphlosionMega,
    [SPECIES_URSHIFU_MEGA_RAPID_STRIKE] = gMonIcon_UrshifuMegaRapidStrike,
    [SPECIES_URSHIFU_MEGA_SINGLE_STRIKE] = gMonIcon_UrshifuMegaSingleStrike,
    [SPECIES_VENUSAUR_MEGA_G] = gMonIcon_VenusaurMegaG,
...
// ROWEMEGA-PORT-END icontable
// ROWESPEC-PORT-START icons (generated by tools/character_mode/port_2x_species.py)
    [SPECIES_BASCULIN_WHITE_STRIPED] = gMonIcon_Basculin_Whitestriped,
    [SPECIES_DARMANITAN_GALAR_ZEN] = gMonIcon_Darmanitan,
    [SPECIES_DIALGA_ORIGIN] = gMonIcon_Dialga,
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] = gMonIcon_Dudunsparce,
    [SPECIES_FLOETTE_ETERNAL_MEGA] = gMonIcon_Floette,
    [SPECIES_FLOETTE_MEGA] = gMonIcon_Floette_Mega,
    [SPECIES_MAUSHOLD_FOUR] = gMonIcon_Maushold,
    [SPECIES_MEOWSTIC_MEGA_F] = gMonIcon_Meowstic_Mega_Female,
    [SPECIES_MINIOR_METEOR] = gMonIcon_Minior,
    ...
    [SPECIES_OINKOLOGNE_F] = gMonIcon_Oinkologne,
    [SPECIES_PALAFIN_HERO] = gMonIcon_Palafin,
    [SPECIES_PALKIA_ORIGIN] = gMonIcon_Palkia,
    [SPECIES_POLTCHAGEIST_ARTISAN] = gMonIcon_Poltchageist,
    [SPECIES_SANDSLASH_MEGA_ALOLA] = gMonIcon_Sandslash_Mega_Alolan,
    [SPECIES_SHEDINJA_MEGA] = gMonIcon_Shedinja_Mega,
    [SPECIES_SINISTCHA_MASTERPIECE] = gMonIcon_Sinistcha,
    [SPECIES_SQUAWKABILLY_BLUE] = gMonIcon_Squawkabilly,
    [SPECIES_SQUAWKABILLY_GREEN] = gMonIcon_Squawkabilly,
    [SPECIES_SQUAWKABILLY_WHITE] = gMonIcon_Squawkabilly,
    [SPECIES_SQUAWKABILLY_YELLOW] = gMonIcon_Squawkabilly,
    [SPECIES_TATSUGIRI_CURLY] = gMonIcon_Tatsugiri,
    [SPECIES_TATSUGIRI_DROOPY] = gMonIcon_Tatsugiri,
    [SPECIES_TATSUGIRI_MEGA_DROOPY] = gMonIcon_Tatsugiri_Mega_Droopy,
    [SPECIES_TATSUGIRI_MEGA_STRETCHY] = gMonIcon_Tatsugiri_Mega_Stretchy,
    [SPECIES_TATSUGIRI_STRETCHY] = gMonIcon_Tatsugiri,
    [SPECIES_TAUROS_PALDEA_AQUA] = gMonIcon_Tauros,
    [SPECIES_TAUROS_PALDEA_BLAZE] = gMonIcon_Tauros,
    [SPECIES_TAUROS_PALDEA_COMBAT] = gMonIcon_Tauros_Paldean_Combat_Breed,
    [SPECIES_TERAPAGOS_STELLAR] = gMonIcon_Ogerpon,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_EGG] = 1,
// GEN9-PORT-START iconpals (generated by tools/character_mode/port_gen9.py)
    ...
    [SPECIES_TERAPAGOS] = 0,
    [SPECIES_PECHARUNT] = 0,
// GEN9-PORT-END iconpals
// ROWEMEGA-PORT-START iconpals (generated by tools/character_mode/port_rowe_megas.py)
    [SPECIES_ABSOL_MEGA_Z] = 0,
    [SPECIES_ALCREMIE_MEGA] = 1,
    [SPECIES_APPLETUN_MEGA] = 1,
    [SPECIES_ARBOK_MEGA] = 2,
    [SPECIES_BARBARACLE_MEGA] = 2,
    [SPECIES_BAXCALIBUR_MEGA] = 0,
    [SPECIES_BLASTOISE_MEGA_G] = 2,
    ...
    [SPECIES_SAMUROTT_HISUI_MEGA] = 0,
    [SPECIES_SAMUROTT_MEGA] = 2,
    ...
    [SPECIES_SLOWBRO_GALAR_MEGA] = 0,
    [SPECIES_SLOWKING_GALAR_MEGA] = 0,
    [SPECIES_SLOWKING_MEGA] = 0,
    [SPECIES_SNORLAX_MEGA] = 3,
    [SPECIES_STARAPTOR_MEGA] = 0,
    [SPECIES_STARMIE_MEGA] = 2,
    [SPECIES_STARMIE_MEGA_REDUX] = 2,
    [SPECIES_TATSUGIRI_MEGA_CURLY] = 0,
    [SPECIES_TINKATON_MEGA] = 1,
    [SPECIES_TOUCANNON_MEGA] = 0,
    [SPECIES_TOXTRICITY_MEGA] = 2,
    [SPECIES_TOXTRICITY_MEGA_LOW_KEY] = 0,
    [SPECIES_TSAREENA_MEGA] = 1,
    [SPECIES_TYPHLOSION_HISUI_MEGA] = 0,
    [SPECIES_TYPHLOSION_MEGA] = 3,
    [SPECIES_URSHIFU_MEGA_RAPID_STRIKE] = 0,
    [SPECIES_URSHIFU_MEGA_SINGLE_STRIKE] = 2,
    [SPECIES_VENUSAUR_MEGA_G] = 4,
    [SPECIES_VICTREEBEL_MEGA] = 1,
    [SPECIES_ZERAORA_MEGA] = 0,
    [SPECIES_ZYGARDE_MEGA] = 1,
// ROWEMEGA-PORT-END iconpals
// ROWESPEC-PORT-START iconpals (generated by tools/character_mode/port_2x_species.py)
    [SPECIES_BASCULIN_WHITE_STRIPED] = 1,
    [SPECIES_DARMANITAN_GALAR_ZEN] = 0,
    [SPECIES_DIALGA_ORIGIN] = 2,
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] = 0,
    [SPECIES_FLOETTE_ETERNAL_MEGA] = 1,
    [SPECIES_FLOETTE_MEGA] = 1,
    [SPECIES_MAUSHOLD_FOUR] = 1,
    [SPECIES_MEOWSTIC_MEGA_F] = 0,
    [SPECIES_MINIOR_METEOR] = 0,
    ...
    [SPECIES_POLTCHAGEIST_ARTISAN] = 1,
    [SPECIES_SANDSLASH_MEGA_ALOLA] = 2,
