...
// CHARMODE-SPRITES-START back-frameimgs (generated by tools/character_mode/import_sprites.py)
const struct SpriteFrameImage gTrainerBackPicTable_CmEthan[] =
{
    gTrainerBackPic_CmEthan, 0x0800,
    gTrainerBackPic_CmEthan + 0x0800, 0x0800,
    gTrainerBackPic_CmEthan + 0x1000, 0x0800,
    gTrainerBackPic_CmEthan + 0x1800, 0x0800,
};
const struct SpriteFrameImage gTrainerBackPicTable_CmKris[] =
{
    gTrainerBackPic_CmKris, 0x0800,
    gTrainerBackPic_CmKris + 0x0800, 0x0800,
    gTrainerBackPic_CmKris + 0x1000, 0x0800,
    gTrainerBackPic_CmKris + 0x1800, 0x0800,
};
const struct SpriteFrameImage gTrainerBackPicTable_CmLucas[] =
{
    gTrainerBackPic_CmLucas, 0x0800,
    gTrainerBackPic_CmLucas + 0x0800, 0x0800,
    gTrainerBackPic_CmLucas + 0x1000, 0x0800,
    gTrainerBackPic_CmLucas + 0x1800, 0x0800,
};
const struct SpriteFrameImage gTrainerBackPicTable_CmDawn[] =
{
    gTrainerBackPic_CmDawn, 0x0800,
    gTrainerBackPic_CmDawn + 0x0800, 0x0800,
    gTrainerBackPic_CmDawn + 0x1000, 0x0800,
    gTrainerBackPic_CmDawn + 0x1800, 0x0800,
};
const struct SpriteFrameImage gTrainerBackPicTable_CmBarry[] =
{
    gTrainerBackPic_CmBarry, 0x0800,
    gTrainerBackPic_CmBarry + 0x0800, 0x0800,
    gTrainerBackPic_CmBarry + 0x1000, 0x0800,
    gTrainerBackPic_CmBarry + 0x1800, 0x0800,
};
// CHARMODE-SPRITES-END back-frameimgs
// CHARMODE-SPRITES-START donor-back-frameimgs (generated by tools/character_mode/import_donor_ow_backs.py)
const struct SpriteFrameImage gTrainerBackPicTable_CmBlue[] =
{
    gTrainerBackPic_CmBlue, 0x0800,
    gTrainerBackPic_CmBlue + 0x0800, 0x0800,
    gTrainerBackPic_CmBlue + 0x1000, 0x0800,
    gTrainerBackPic_CmBlue + 0x1800, 0x0800,
    gTrainerBackPic_CmBlue + 0x2000, 0x0800,
};
const struct SpriteFrameImage gTrainerBackPicTable_CmLance[] =
{
    gTrainerBackPic_CmLance, 0x0800,
    gTrainerBackPic_CmLance + 0x0800, 0x0800,
    gTrainerBackPic_CmLance + 0x1000, 0x0800,
    gTrainerBackPic_CmLance + 0x1800, 0x0800,
    gTrainerBackPic_CmLance + 0x2000, 0x0800,
};
const struct SpriteFrameImage gTrainerBackPicTable_CmLyra[] =
{
    gTrainerBackPic_CmLyra, 0x0800,
    gTrainerBackPic_CmLyra + 0x0800, 0x0800,
    gTrainerBackPic_CmLyra + 0x1000, 0x0800,
    gTrainerBackPic_CmLyra + 0x1800, 0x0800,
    gTrainerBackPic_CmLyra + 0x2000, 0x0800,
};
const struct SpriteFrameImage gTrainerBackPicTable_CmPhoebe[] =
{
    gTrainerBackPic_CmPhoebe, 0x0800,
    gTrainerBackPic_CmPhoebe + 0x0800, 0x0800,
    gTrainerBackPic_CmPhoebe + 0x1000, 0x0800,
    gTrainerBackPic_CmPhoebe + 0x1800, 0x0800,
};
const struct SpriteFrameImage gTrainerBackPicTable_CmCalem[] =
{
    gTrainerBackPic_CmCalem, 0x0800,
    gTrainerBackPic_CmCalem + 0x0800, 0x0800,
    gTrainerBackPic_CmCalem + 0x1000, 0x0800,
    gTrainerBackPic_CmCalem + 0x1800, 0x0800,
    gTrainerBackPic_CmCalem + 0x2000, 0x0800,
};
const struct SpriteFrameImage gTrainerBackPicTable_CmSerena[] =
{
    gTrainerBackPic_CmSerena, 0x0800,
    gTrainerBackPic_CmSerena + 0x0800, 0x0800,
    gTrainerBackPic_CmSerena + 0x1000, 0x0800,
...
const struct SpriteFrameImage gTrainerBackPicTable_CmNoland[] =
{
    ...
    gTrainerBackPic_CmNoland + 0x0800, 0x0800,
    gTrainerBackPic_CmNoland + 0x1000, 0x0800,
    gTrainerBackPic_CmNoland + 0x1800, 0x0800,
};
// CHARMODE-SPRITES-END donor-back-frameimgs
