...
const u8 gText_SaveFileOldVersion[] = _("Esta partida es de una versión\nanterior y no se puede cargar.\pNo se ha borrado: usa la versión\nanterior para seguir jugándola.");
...
const u8 gText_YouDontHaveBP[] = _("No tienes suficientes PB.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Var1BP[] = _("{STR_VAR_1}BP");
...
const u8 gText_MenuTrainerSkills[] = _("Skills");
const u8 gText_ItemSentToPC[] = _("The Bag is full…\pThe item was sent to the PC.");
...
const u8 gText_SaveFileOldVersion[] = _("This save file was made by an\nearlier version and can't be read.\pIt has not been erased. Use that\nversion to keep playing it.");
