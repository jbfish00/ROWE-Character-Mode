...
// GEN9-PORT-START spec2nat (generated by tools/character_mode/port_gen9.py)
    [SPECIES_SPRIGATITO] = NATIONAL_DEX_SPRIGATITO,
    [SPECIES_FLORAGATO] = NATIONAL_DEX_FLORAGATO,
    [SPECIES_MEOWSCARADA] = NATIONAL_DEX_MEOWSCARADA,
    [SPECIES_FUECOCO] = NATIONAL_DEX_FUECOCO,
    [SPECIES_CROCALOR] = NATIONAL_DEX_CROCALOR,
    [SPECIES_SKELEDIRGE] = NATIONAL_DEX_SKELEDIRGE,
    [SPECIES_QUAXLY] = NATIONAL_DEX_QUAXLY,
    [SPECIES_QUAXWELL] = NATIONAL_DEX_QUAXWELL,
    [SPECIES_QUAQUAVAL] = NATIONAL_DEX_QUAQUAVAL,
    [SPECIES_LECHONK] = NATIONAL_DEX_LECHONK,
    [SPECIES_OINKOLOGNE] = NATIONAL_DEX_OINKOLOGNE,
    [SPECIES_TAROUNTULA] = NATIONAL_DEX_TAROUNTULA,
    [SPECIES_SPIDOPS] = NATIONAL_DEX_SPIDOPS,
    [SPECIES_NYMBLE] = NATIONAL_DEX_NYMBLE,
    [SPECIES_LOKIX] = NATIONAL_DEX_LOKIX,
    [SPECIES_PAWMI] = NATIONAL_DEX_PAWMI,
    [SPECIES_PAWMO] = NATIONAL_DEX_PAWMO,
    [SPECIES_PAWMOT] = NATIONAL_DEX_PAWMOT,
    [SPECIES_TANDEMAUS] = NATIONAL_DEX_TANDEMAUS,
    [SPECIES_MAUSHOLD] = NATIONAL_DEX_MAUSHOLD,
    [SPECIES_FIDOUGH] = NATIONAL_DEX_FIDOUGH,
    [SPECIES_DACHSBUN] = NATIONAL_DEX_DACHSBUN,
    [SPECIES_SMOLIV] = NATIONAL_DEX_SMOLIV,
    [SPECIES_DOLLIV] = NATIONAL_DEX_DOLLIV,
    [SPECIES_ARBOLIVA] = NATIONAL_DEX_ARBOLIVA,
    [SPECIES_SQUAWKABILLY] = NATIONAL_DEX_SQUAWKABILLY,
    [SPECIES_NACLI] = NATIONAL_DEX_NACLI,
    [SPECIES_NACLSTACK] = NATIONAL_DEX_NACLSTACK,
    [SPECIES_GARGANACL] = NATIONAL_DEX_GARGANACL,
    [SPECIES_CHARCADET] = NATIONAL_DEX_CHARCADET,
    [SPECIES_ARMAROUGE] = NATIONAL_DEX_ARMAROUGE,
    [SPECIES_CERULEDGE] = NATIONAL_DEX_CERULEDGE,
    [SPECIES_TADBULB] = NATIONAL_DEX_TADBULB,
    [SPECIES_BELLIBOLT] = NATIONAL_DEX_BELLIBOLT,
    [SPECIES_WATTREL] = NATIONAL_DEX_WATTREL,
    [SPECIES_KILOWATTREL] = NATIONAL_DEX_KILOWATTREL,
    [SPECIES_MASCHIFF] = NATIONAL_DEX_MASCHIFF,
    [SPECIES_MABOSSTIFF] = NATIONAL_DEX_MABOSSTIFF,
    [SPECIES_SHROODLE] = NATIONAL_DEX_SHROODLE,
    [SPECIES_GRAFAIAI] = NATIONAL_DEX_GRAFAIAI,
    [SPECIES_BRAMBLIN] = NATIONAL_DEX_BRAMBLIN,
    [SPECIES_BRAMBLEGHAST] = NATIONAL_DEX_BRAMBLEGHAST,
    [SPECIES_TOEDSCOOL] = NATIONAL_DEX_TOEDSCOOL,
    [SPECIES_TOEDSCRUEL] = NATIONAL_DEX_TOEDSCRUEL,
    [SPECIES_KLAWF] = NATIONAL_DEX_KLAWF,
    [SPECIES_CAPSAKID] = NATIONAL_DEX_CAPSAKID,
    [SPECIES_SCOVILLAIN] = NATIONAL_DEX_SCOVILLAIN,
    [SPECIES_RELLOR] = NATIONAL_DEX_RELLOR,
    [SPECIES_RABSCA] = NATIONAL_DEX_RABSCA,
    [SPECIES_FLITTLE] = NATIONAL_DEX_FLITTLE,
    [SPECIES_ESPATHRA] = NATIONAL_DEX_ESPATHRA,
    [SPECIES_TINKATINK] = NATIONAL_DEX_TINKATINK,
    [SPECIES_TINKATUFF] = NATIONAL_DEX_TINKATUFF,
    [SPECIES_TINKATON] = NATIONAL_DEX_TINKATON,
    [SPECIES_WIGLETT] = NATIONAL_DEX_WIGLETT,
    [SPECIES_WUGTRIO] = NATIONAL_DEX_WUGTRIO,
    [SPECIES_BOMBIRDIER] = NATIONAL_DEX_BOMBIRDIER,
    [SPECIES_FINIZEN] = NATIONAL_DEX_FINIZEN,
    [SPECIES_PALAFIN] = NATIONAL_DEX_PALAFIN,
    [SPECIES_VAROOM] = NATIONAL_DEX_VAROOM,
    [SPECIES_REVAVROOM] = NATIONAL_DEX_REVAVROOM,
    [SPECIES_CYCLIZAR] = NATIONAL_DEX_CYCLIZAR,
    [SPECIES_ORTHWORM] = NATIONAL_DEX_ORTHWORM,
    [SPECIES_GLIMMET] = NATIONAL_DEX_GLIMMET,
    [SPECIES_GLIMMORA] = NATIONAL_DEX_GLIMMORA,
    [SPECIES_GREAVARD] = NATIONAL_DEX_GREAVARD,
    [SPECIES_HOUNDSTONE] = NATIONAL_DEX_HOUNDSTONE,
    [SPECIES_FLAMIGO] = NATIONAL_DEX_FLAMIGO,
    [SPECIES_CETODDLE] = NATIONAL_DEX_CETODDLE,
    [SPECIES_CETITAN] = NATIONAL_DEX_CETITAN,
    [SPECIES_VELUZA] = NATIONAL_DEX_VELUZA,
    [SPECIES_DONDOZO] = NATIONAL_DEX_DONDOZO,
    [SPECIES_TATSUGIRI] = NATIONAL_DEX_TATSUGIRI,
    [SPECIES_ANNIHILAPE] = NATIONAL_DEX_ANNIHILAPE,
    [SPECIES_CLODSIRE] = NATIONAL_DEX_CLODSIRE,
    [SPECIES_FARIGIRAF] = NATIONAL_DEX_FARIGIRAF,
    [SPECIES_DUDUNSPARCE] = NATIONAL_DEX_DUDUNSPARCE,
    [SPECIES_KINGAMBIT] = NATIONAL_DEX_KINGAMBIT,
    [SPECIES_GREAT_TUSK] = NATIONAL_DEX_GREAT_TUSK,
    [SPECIES_SCREAM_TAIL] = NATIONAL_DEX_SCREAM_TAIL,
    [SPECIES_BRUTE_BONNET] = NATIONAL_DEX_BRUTE_BONNET,
    [SPECIES_FLUTTER_MANE] = NATIONAL_DEX_FLUTTER_MANE,
    [SPECIES_SLITHER_WING] = NATIONAL_DEX_SLITHER_WING,
    [SPECIES_SANDY_SHOCKS] = NATIONAL_DEX_SANDY_SHOCKS,
    [SPECIES_IRON_TREADS] = NATIONAL_DEX_IRON_TREADS,
    [SPECIES_IRON_BUNDLE] = NATIONAL_DEX_IRON_BUNDLE,
    [SPECIES_IRON_HANDS] = NATIONAL_DEX_IRON_HANDS,
    [SPECIES_IRON_JUGULIS] = NATIONAL_DEX_IRON_JUGULIS,
    [SPECIES_IRON_MOTH] = NATIONAL_DEX_IRON_MOTH,
    [SPECIES_IRON_THORNS] = NATIONAL_DEX_IRON_THORNS,
    [SPECIES_FRIGIBAX] = NATIONAL_DEX_FRIGIBAX,
    [SPECIES_ARCTIBAX] = NATIONAL_DEX_ARCTIBAX,
    [SPECIES_BAXCALIBUR] = NATIONAL_DEX_BAXCALIBUR,
    [SPECIES_GIMMIGHOUL] = NATIONAL_DEX_GIMMIGHOUL,
    [SPECIES_GHOLDENGO] = NATIONAL_DEX_GHOLDENGO,
    [SPECIES_WO_CHIEN] = NATIONAL_DEX_WO_CHIEN,
    [SPECIES_CHIEN_PAO] = NATIONAL_DEX_CHIEN_PAO,
    [SPECIES_TING_LU] = NATIONAL_DEX_TING_LU,
    [SPECIES_CHI_YU] = NATIONAL_DEX_CHI_YU,
    [SPECIES_ROARING_MOON] = NATIONAL_DEX_ROARING_MOON,
    [SPECIES_IRON_VALIANT] = NATIONAL_DEX_IRON_VALIANT,
    [SPECIES_KORAIDON] = NATIONAL_DEX_KORAIDON,
    [SPECIES_MIRAIDON] = NATIONAL_DEX_MIRAIDON,
    [SPECIES_WALKING_WAKE] = NATIONAL_DEX_WALKING_WAKE,
    [SPECIES_IRON_LEAVES] = NATIONAL_DEX_IRON_LEAVES,
    [SPECIES_DIPPLIN] = NATIONAL_DEX_DIPPLIN,
    [SPECIES_POLTCHAGEIST] = NATIONAL_DEX_POLTCHAGEIST,
    [SPECIES_SINISTCHA] = NATIONAL_DEX_SINISTCHA,
    [SPECIES_OKIDOGI] = NATIONAL_DEX_OKIDOGI,
    [SPECIES_MUNKIDORI] = NATIONAL_DEX_MUNKIDORI,
    [SPECIES_FEZANDIPITI] = NATIONAL_DEX_FEZANDIPITI,
    [SPECIES_OGERPON] = NATIONAL_DEX_OGERPON,
    [SPECIES_ARCHALUDON] = NATIONAL_DEX_ARCHALUDON,
    [SPECIES_HYDRAPPLE] = NATIONAL_DEX_HYDRAPPLE,
    [SPECIES_GOUGING_FIRE] = NATIONAL_DEX_GOUGING_FIRE,
    [SPECIES_RAGING_BOLT] = NATIONAL_DEX_RAGING_BOLT,
    [SPECIES_IRON_BOULDER] = NATIONAL_DEX_IRON_BOULDER,
    [SPECIES_IRON_CROWN] = NATIONAL_DEX_IRON_CROWN,
    [SPECIES_TERAPAGOS] = NATIONAL_DEX_TERAPAGOS,
    [SPECIES_PECHARUNT] = NATIONAL_DEX_PECHARUNT,
// GEN9-PORT-END spec2nat
};
...
// CHARMODE-SPRITES-START back-templates (generated by tools/character_mode/import_sprites.py)
    {
        .tileTag = 0xFFFF,
        .paletteTag = 0,
        .oam = &gOamData_831ACB0,
        .anims = NULL,
        .images = gTrainerBackPicTable_CmEthan,
        .affineAnims = gUnknown_082FF618,
        .callback = sub_8039BB4,
    },
    {
        ...
        .oam = &gOamData_831ACB0,
        .anims = NULL,
        .images = gTrainerBackPicTable_CmKris,
        .affineAnims = gUnknown_082FF618,
        .callback = sub_8039BB4,
    },
    {
        ...
        .oam = &gOamData_831ACB0,
        .anims = NULL,
        .images = gTrainerBackPicTable_CmLucas,
        .affineAnims = gUnknown_082FF618,
        .callback = sub_8039BB4,
    },
    {
        ...
        .oam = &gOamData_831ACB0,
        .anims = NULL,
        .images = gTrainerBackPicTable_CmDawn,
        .affineAnims = gUnknown_082FF618,
        .callback = sub_8039BB4,
    },
    {
        ...
        .oam = &gOamData_831ACB0,
        .anims = NULL,
        .images = gTrainerBackPicTable_CmBarry,
        .affineAnims = gUnknown_082FF618,
        .callback = sub_8039BB4,
    },
// CHARMODE-SPRITES-END back-templates
};
