...
// ROWENEWTRN-START money (generated by tools/character_mode/port_2x_new_trainers.py)
    {TRAINER_CLASS_PAINTER, 16},
    {TRAINER_CLASS_TEAM_ROCKET, 20},
    {TRAINER_CLASS_SCIENTIST, 48},
    {TRAINER_CLASS_JUGGLER, 32},
    {TRAINER_CLASS_COOL_COUPLE, 24},
    {TRAINER_CLASS_TAMER, 36},
    {TRAINER_CLASS_CRUSH_GIRL, 24},
// ROWENEWTRN-END money
    {0xFF, 5},
};
