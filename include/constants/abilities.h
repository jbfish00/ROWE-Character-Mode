...
// ROWEABIL-PORT-START consts (generated by tools/character_mode/port_2x_abilities.py)
...
// 2.X renamed id 275; our engine still runs the 1.9.4 Early Evolver effect (revisit in ability-effects phase)
#define ABILITY_POWER_SURGE                 ABILITY_EARLY_EVOLVER

#define ABILITIES_COUNT_GEN8    ABILITY_EERIE_VOICE + 1
// ROWEABIL-PORT-END consts
