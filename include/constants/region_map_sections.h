...
// Eight Island reuses 0x9D, exactly as 2.X does. It was 0xD6 -- PAST MAPSEC_NONE
// (0xD5) and two entries past the end of gRegionMapEntries[] (213 entries, 0..0xD4).
// region_map.c and pokedex_area_screen.c index that array UNGUARDED, so opening the
// region map divided by a garbage width. Same out-of-bounds class as the
// gBattleAnims_Moves crash.
#define MAPSEC_SEVII_ISLE_8                 0x9D
#define MAPSEC_EIGHT_ISLAND                 0x9D
