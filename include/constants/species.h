...
#define SPECIES_SAMUROTT_MEGA (ROWE_MEGA_START + 68)
#define SPECIES_SANDACONDA_MEGA (ROWE_MEGA_START + 69)
#define SPECIES_SANDSLASH_MEGA (ROWE_MEGA_START + 70)
#define SPECIES_SCOLIPEDE_MEGA (ROWE_MEGA_START + 71)
#define SPECIES_SCOVILLAIN_MEGA (ROWE_MEGA_START + 72)
#define SPECIES_SCRAFTY_MEGA (ROWE_MEGA_START + 73)
#define SPECIES_SERPERIOR_MEGA (ROWE_MEGA_START + 74)
#define SPECIES_SHUCKLE_MEGA (ROWE_MEGA_START + 75)
#define SPECIES_SKARMORY_MEGA (ROWE_MEGA_START + 76)
#define SPECIES_SLOWKING_MEGA (ROWE_MEGA_START + 77)
#define SPECIES_SNORLAX_MEGA (ROWE_MEGA_START + 78)
#define SPECIES_STARAPTOR_MEGA (ROWE_MEGA_START + 79)
#define SPECIES_STARMIE_MEGA (ROWE_MEGA_START + 80)
#define SPECIES_STARMIE_MEGA_REDUX (ROWE_MEGA_START + 81)
#define SPECIES_TATSUGIRI_MEGA_CURLY (ROWE_MEGA_START + 82)
#define SPECIES_TINKATON_MEGA (ROWE_MEGA_START + 83)
#define SPECIES_TOUCANNON_MEGA (ROWE_MEGA_START + 84)
#define SPECIES_TOXTRICITY_MEGA (ROWE_MEGA_START + 85)
#define SPECIES_TOXTRICITY_MEGA_LOW_KEY (ROWE_MEGA_START + 86)
#define SPECIES_TSAREENA_MEGA (ROWE_MEGA_START + 87)
#define SPECIES_TYPHLOSION_MEGA (ROWE_MEGA_START + 88)
#define SPECIES_URSHIFU_MEGA_SINGLE_STRIKE (ROWE_MEGA_START + 89)
#define SPECIES_VENUSAUR_MEGA_G (ROWE_MEGA_START + 90)
#define SPECIES_VICTREEBEL_MEGA (ROWE_MEGA_START + 91)
#define SPECIES_ZERAORA_MEGA (ROWE_MEGA_START + 92)
#define SPECIES_ZYGARDE_MEGA (ROWE_MEGA_START + 93)
#undef SPECIES_EGG
#undef NUM_SPECIES
